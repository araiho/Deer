...
#####	
  ...
  for (i in length(N.obsno1s[,1])-39:length(N.obsno1s[,1])){
    ...
    M.1yr[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*f.adult.1yr[N.obsno1s[i,4],N.obsno1s[i,3]]
    M.1yr[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*(1-treated.fawns)
    M.1yr[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does)
    M.1yr[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*(1-ratio)
    M.1yr[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male
  
    M.1yr[2,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does)
    M.1yr[4,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*treated.fawns
    M.1yr[4,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*treated.does
    M.1yr[4,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*treated.does
    ...
    M.ster[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*f.adult.ster[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does)
    M.ster[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*(1-treated.fawns)
    M.ster[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does)
    M.ster[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*(1-ratio)
    M.ster[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male
  
    M.ster[4,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*treated.fawns 
    M.ster[4,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*treated.does
    M.ster[4,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female    
    ...
    M.cull[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*f.adult.cull[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does)
    M.cull[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*(1-treated.fawns)
    M.cull[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does)
...
######
  ...
  M.lambda.cull[1,2] <- s.adult.female*f.adult.lambda*(1-treated.does)
  M.lambda.cull[2,1] <- s.fawn*ratio
  M.lambda.cull[2,2] <- s.adult.female*(1-treated.does)
  
  M.lambda.ster[1,2] <- s.adult.female*f.adult.lambda*(1-treated.does)
  M.lambda.ster[2,1] <- s.fawn*ratio
  M.lambda.ster[2,2] <- s.adult.female*(1-treated.does)
  M.lambda.ster[3,2] <- s.adult.female*treated.does
  M.lambda.ster[3,3] <- s.adult.female
  
  M.lambda.1yr[1,2] <- s.adult.female*f.adult.lambda
  M.lambda.1yr[2,1] <- s.fawn*ratio
  M.lambda.1yr[2,2] <- s.adult.female*(1-treated.does)
  M.lambda.1yr[2,3] <- s.adult.female*(1-treated.does)
  M.lambda.1yr[3,2] <- s.adult.female*treated.does
  M.lambda.1yr[3,3] <- s.adult.female*treated.does
  
M.lambda.3yr[1,2] <- s.adult.female*f.adult.lambda
M.lambda.3yr[2,1] <- s.fawn*ratio
M.lambda.3yr[2,2] <- s.adult.female*(1-treated.does)
M.lambda.3yr[2,3] <- s.adult.female*(1-treated.does)*(1-effect)
M.lambda.3yr[3,2] <- s.adult.female*treated.does
M.lambda.3yr[3,3] <- s.adult.female*treated.does+s.adult.female*(1-treated.does)*effect  
