var N[4,T,Park], mu[4,T,Park], mu.3yr[4,T,Park], mu.1yr[4,T,Park], mu.ster[4,T,Park], mu.cull[4,T,Park]
...
#####
##### Killing 90% the First Year #####
#####		

treated.does.first<-.9
		
	for (i in length(N.obsno1s[,1])-39:length(N.obsno1s[,1])-32){
	
	f.adult.cull[N.obsno1s[i,4],N.obsno1s[i,3]] <- min(5,exp(r-(r/beta)*denNpark.cull[N.obsno1s[i,4]-1,N.obsno1s[i,3]]))
  
    M.cull[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*f.adult.cull[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does.first)
    M.cull[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*(1-treated.fawns)
    M.cull[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does.first)
    M.cull[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*(1-ratio)
    M.cull[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male 
	...
	sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]] <- sum(N.cull[1:4,N.obsno1s[i,4],N.obsno1s[i,3]])
	sumNpark.3yr[N.obsno1s[i,4],N.obsno1s[i,3]] <- sum(N.cull[1:4,N.obsno1s[i,4],N.obsno1s[i,3]])
	sumNpark.1yr[N.obsno1s[i,4],N.obsno1s[i,3]] <- sum(N.cull[1:4,N.obsno1s[i,4],N.obsno1s[i,3]])
	sumNpark.ster[N.obsno1s[i,4],N.obsno1s[i,3]] <- sum(N.cull[1:4,N.obsno1s[i,4],N.obsno1s[i,3]])
	
	denNpark[N.obsno1s[i,4],N.obsno1s[i,3]] <- sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]]/area[N.obsno1s[i,3]]
	denNpark.3yr[N.obsno1s[i,4],N.obsno1s[i,3]] <- sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]]/area[N.obsno1s[i,3]]
	denNpark.1yr[N.obsno1s[i,4],N.obsno1s[i,3]] <- sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]]/area[N.obsno1s[i,3]]
	denNpark.ster[N.obsno1s[i,4],N.obsno1s[i,3]] <- sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]]/area[N.obsno1s[i,3]]
	denNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]] <- sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]]/area[N.obsno1s[i,3]]
	
	
	N.3yr[1:3,N.obsno1s[i,4],N.obsno1s[i,3]] <- N.cull[1:3,N.obsno1s[i,4],N.obsno1s[i,3]]
	N.1yr[1:3,N.obsno1s[i,4],N.obsno1s[i,3]] <- N.cull[1:3,N.obsno1s[i,4],N.obsno1s[i,3]]
	N.ster[1:3,N.obsno1s[i,4],N.obsno1s[i,3]] <- N.cull[1:3,N.obsno1s[i,4],N.obsno1s[i,3]]
...
#####	
  ...
  for (i in length(N.obsno1s[,1])-31:length(N.obsno1s[,1])){
    ...
    M.3yr[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*f.adult.3yr[N.obsno1s[i,4],N.obsno1s[i,3]]
    M.3yr[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*(1-treated.fawns)
    M.3yr[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-treated.does)
    M.3yr[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*(1-ratio)
    M.3yr[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male
  
    M.3yr[4,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn*ratio*treated.fawns
    M.3yr[4,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*treated.does
    M.3yr[2,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(1-effect)*(1-treated.does)
    M.3yr[4,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female*(treated.does)+s.adult.female*(1-treated.does)*effect
    ...
    M.1yr[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*f.adult.1yr[N.obsno1s[i,4],N.obsno1s[i,3]]
    M.1yr[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*ratio*(1-treated.fawns)
    M.1yr[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*(1-treated.does)
    M.1yr[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*(1-ratio)
    M.1yr[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male[1]
  
    M.1yr[2,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*(1-treated.does)
    M.1yr[4,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*ratio*treated.fawns
    M.1yr[4,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*treated.does
    M.1yr[4,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*treated.does
    ...
    M.ster[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*f.adult.ster[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does)
    M.ster[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*ratio*(1-treated.fawns)
    M.ster[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*(1-treated.does)
    M.ster[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*(1-ratio)
    M.ster[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male[1]
  
    M.ster[4,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*ratio*treated.fawns 
    M.ster[4,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*treated.does
    M.ster[4,4,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]    
    ...
    M.cull[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*f.adult.cull[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does)
    M.cull[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*ratio*(1-treated.fawns)
    M.cull[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[1]*(1-treated.does)
    M.cull[3,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[1]*(1-ratio)
    M.cull[3,3,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.male[1] 
	...
	sumNpark.cull[N.obsno1s[i,4],N.obsno1s[i,3]] <- sum(N.cull[,N.obsno1s[i,4],N.obsno1s[i,3]])
...
for(i in 2:T){
  ...
  sumN.3yr[1,i] <-sum(sumNpark.3yr[i,1:Park])
  sumN.1yr[1,i] <-sum(sumNpark.1yr[i,1:Park])
  sumN.ster[1,i] <-sum(sumNpark.ster[i,1:Park])
  sumN.cull[1,i] <-sum(sumNpark.cull[i,1:Park])
