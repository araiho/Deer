...
model{
  ...
  for (i in length(N.obsno1s[,1])-39:length(N.obsno1s[,1])-32){
    ...
    M.cull[1,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[N.obsno1s[i,3]]*f.adult.cull[N.obsno1s[i,4],N.obsno1s[i,3]]*(1-treated.does.first)
    M.cull[2,1,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.fawn[N.obsno1s[i,3]]*ratio*(1-treated.fawns)
    M.cull[2,2,N.obsno1s[i,3],N.obsno1s[i,4]] <- s.adult.female[N.obsno1s[i,3]]*(1-treated.does.first)
